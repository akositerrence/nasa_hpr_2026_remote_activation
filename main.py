...
COM_PORT = "COM14"          # Change this to your LoRa USB adapter COM port
BAUD_RATE = 9600           # DX-LR02 default is usually 9600
RECEIVER_ADDRESS = 2       # Change if your ESP-side LoRa address is different

# Use "AT" if the module is still in AT/fixed-address mode.
# Use "RAW" only if both modules are in transparent mode.
SEND_MODE = "AT"
